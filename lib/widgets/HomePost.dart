            ...
            child: GestureDetector(
              ...
              child: Wrap(
                ...
                children: [
                  HomePostAttribute(
                    title:
                    "Since ${timeago.format(DateTime.fromMillisecondsSinceEpoch(
                        widget.postData['timestamp']))}",
                    icon: Icon(Icons.history, size: 20),
                  ),
                  HomePostAttribute(title: widget.postData['title'] ?? " "),
                  Container(
                    width: 350,
                    height: 196,
                    ...
                    onTap: () {
                      if (widget.postData['uid'] != AuthService.uid) {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                UserProfile(viewingUID: widget.postData['uid']),
                          ),
                        );
                        Fluttertoast.showToast(
                          msg: "Viewing user: ${widget.postData['username']}",
                        );
                      } else {
