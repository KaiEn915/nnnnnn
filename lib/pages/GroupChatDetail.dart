                                ...
                                Container(
                                  ...
                                  child: FutureBuilder<List<Map<String,dynamic>>>(
                                    ...
                                    builder: (context, membersData) {
                                      if (!membersData.hasData) return CircularProgressIndicator();
                                      return Scrollbar(
                                          child: SingleChildScrollView(
                                              child: Wrap(
                                                  ...
                                                  children: membersData.data!.map((user) {
                                                    ...
                                                    Timestamp lastUpdated=user['lastUpdated'];
                                                    final isOnline = DateTime.now().difference(lastUpdated.toDate()).inMinutes<=10;
