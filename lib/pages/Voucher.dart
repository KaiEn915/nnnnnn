...
class _addVoucher extends State<Voucher> {
  ...
  Widget build(BuildContext context) {
    ...
    if (args != null && !hasSaved) {
      saveChat(
        title: args['title'],
        requirePoint: args['requiredPoints'],
        discountPercentage: args['discountPercentage'],
        discountCap: args['discountCap'],
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: dbRef.collection("userVouchers").snapshots(),
                        ...
                        child: Wrap(
                          ...
                          children: vouchers.map((voucher) {
                            ...
                            final formattedExpiry =
                                'DUE${expiryDate.day}/${expiryDate.month}/${expiryDate.year}';
